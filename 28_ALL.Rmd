...
PerCorrection= c(0.05, 0.1, 0.15, 0.2, 0.25)
...
```{r, echo=FALSE, message=FALSE,warning=FALSE, fig.align = 'center', fig.width =12, fig.height = 3}
subplot(AUDCHF_1,AUDCHF_2,AUDCHF_3,AUDCHF_4,AUDCHF_5,titleY = FALSE,   titleX = TRUE, margin = 0.015,nrows =1)
```
...
```{r, echo=FALSE, message=FALSE,warning=FALSE, fig.align = 'center', fig.width =12, fig.height = 3}
subplot(CADCHF_1,CADCHF_2,CADCHF_3,CADCHF_4,CADCHF_5,titleY = FALSE,   titleX = TRUE, margin = 0.015,nrows =1)
```
...
```{r, echo=FALSE, message=FALSE,warning=FALSE, fig.align = 'center', fig.width =12, fig.height = 3}
subplot(NZDCAD_1,NZDCAD_2,NZDCAD_3,NZDCAD_4,NZDCAD_5,titleY = FALSE,   titleX = TRUE, margin = 0.015,nrows =1)
```
...
```{r, echo=FALSE, message=FALSE,warning=FALSE, fig.align = 'center', fig.width =12, fig.height = 3}
subplot(NZDCHF_1,NZDCHF_2,NZDCHF_3,NZDCHF_4,NZDCHF_5,titleY = FALSE,   titleX = TRUE, margin = 0.015,nrows =1)
```
