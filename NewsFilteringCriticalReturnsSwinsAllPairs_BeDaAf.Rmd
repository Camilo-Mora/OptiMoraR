...
PlotFilteringNews <- function(Ticker, Date,Change,News, CriticalThreshold, YHover, YAxisName){
        ...
        Results=data.frame(NewsI="Total",CriticalLeft=NcriticalDays, MaxDDLeft=StartMaxDD, DaysLeft=nrow(DataI))
        ...
        ListOfCriticalNews=Results$NewsI
...
#Plot effect on returns of filtering news
    NewsSwinReturn=News
    NewsSwinReturn$event=paste0("(", News$currency, "/", News$Ocurrence, ") ",News$event)
     
    YName=paste0("Critical Returns Left at ",MinDDWanted ,"% in ", TickerX)
    Returns=PlotFilteringNews (Ticker=TickerX, Date=Date, Change=Change,News=NewsSwinReturn, CriticalThreshold=MinDDWanted, YHover="CritReturnsLeft",YAxisName=YName)
...
#Plot effect on swings of filtering news
    ...
    Swings=PlotFilteringNews (Ticker=TickerX, Date=DateSwings, Change=ChangeSwings,News=NewsSwinReturn, CriticalThreshold=ZigZagDDWated, YHover="CritSwingsLeft",YAxisName=YName)
