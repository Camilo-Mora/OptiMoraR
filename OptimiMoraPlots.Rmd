...
Bots are optimized by having the largest number of successful entries while meeting as criteria that DD does not exceed the desired DD ($ `r MinimumDD`) and the entry capital not larger than 10% nor smaller than $1,000 (The smallest amount possible).
